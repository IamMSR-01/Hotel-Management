...
function HotelCard({ room, index }) {
  return (
    <Link className='relative max-w-70 w-full rounded-xl overflow-hidden bg-white text-gray-500/90 shadow-2xl' to={"/rooms/" + room._id} onClick={() => scrollTo(0, 0)} key={room._id}>
