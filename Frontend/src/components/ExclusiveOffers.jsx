...
function ExclusiveOffers() {
  return (
    <div className='flex flex-col items-center px-6 md:px-16 lg:px-24 xl:px-32 pb-30 pt-20'>
        <div className='flex flex-col items-center justify-between w-full md:flex-row'>
            <Title align="left" title="Exclusive Offers" subTitle="Take advantages of ouur limited-time offers and special packages to enhance your stay and create unforgettable memories." font="font-bold" />
            <button className='group flex item-centre gap-2 font-medium cursor-pointer max-md:mt-12'>
                View All Offers
